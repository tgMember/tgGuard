...
chats = {}
day = 86400
bot_id = 279700027 -- [[محل قرار گیری آیدی اکانت ربات]]
sudo_users = {158955285,180191663} -- [[محل قرار گیری آیدی سودو ها]]
bot_owner = {158955285,279700027} -- [[ محل قرار گیری آیدی مدیر اصلی ربات ]]
  -----------------------------------------------------------------------------------------------                  
     ---------------
  -- Start Functions --
     ---------------
